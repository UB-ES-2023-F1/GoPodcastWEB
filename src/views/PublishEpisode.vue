              ...
              <div class="row">
                <div class="col-md-6 mx-auto">
                  <form @submit.prevent="onSubmit" class="publish-form">
                    ...
                    <input type="file" class="form-control" id="audio" @change="onFileChange" required style="max-width: 100%;" />
  
                    <div class="mb-3"></div>
  
                    <div class="form-group">
                      <label for="title" class="label">Title</label>
                      <input type="text" class="form-control" id="title" v-model="title" required style="max-width: 100%;" />
                    </div>
                    <div class="mb-3"></div>
  
                    <div class="form-group">
                      <label for="description" class="label">Brief description</label>
                      <input type="text" class="form-control" id="description" v-model="description" required style="width: 100%;" />
                    </div>
                    <div class="mb-3"></div>
                    ...
                    <button type="submit" class="btn-submit-bold btn btn-dark mt-3" style="width: 100%;" @click="onSubmit">Post Episode</button>
                  </form>
                </div>
              </div>
            </div>
