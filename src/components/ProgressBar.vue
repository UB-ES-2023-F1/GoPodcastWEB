        ...
        <div id="player-row" class="row flex-wrap w-full max-w-5xl">
          <div class="episode-cover d-inline col-4 col-md-4">
            <img
              :src="coverImg"
              alt="cover"
              class="cover p-0 d-none d-lg-inline"
            ...
            <div
              id="button-div"
              class="flex-initial pr-3 ps-md-3"
          ...
          <div id="progress-bar" class="col-8 d-flex align-items-center">
            ...
            <div
              class="overlay-container h-full d-inline px-2"
              style="width: 100%"
            >
              <input
  ...
  mounted() {
    ...
    this.timer = setInterval(() => {
      if (this.$store.state.userIsLoggedIn) {
        ...
        const path = `${import.meta.env.VITE_API_URL}/update_current_sec/${
          this.idEpisode
        }`;
